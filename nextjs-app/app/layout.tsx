...
export const metadata: Metadata = {
  ...
  keywords: [
    "best AI crypto trading helper",
    "best crypto signals",
    "best AI trading helper",
    "best crypto helper",
    "crypto signals without login",
    "free crypto signals no signup",
    "AI trading signals free",
    "crypto helper without login",
    "crypto trading AI",
    "AI crypto analysis",
    "bitcoin AI analysis",
